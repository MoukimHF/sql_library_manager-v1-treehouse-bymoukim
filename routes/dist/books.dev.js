...
router.get('/', asyncHandler(function _callee3(req, res) {
  var page, limit, startIndex, endIndex, books, pageCount, arrayCount, i, bookss;
...
router.post('/', asyncHandler(function _callee4(req, res) {
  var book;
...
router.get("/:id/edit", asyncHandler(function _callee5(req, res) {
  var book;
...
router.get('/:id', asyncHandler(function _callee6(req, res) {
  var book;
...
router.post('/:id/edit', asyncHandler(function _callee7(req, res) {
  var book;
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 13:
          ...
          if (!(_context7.t0.name === "SequelizeValidationError")) {
            _context7.next = 23;
            break;
          }
...
router.get("/:id/delete", asyncHandler(function _callee8(req, res) {
  var book;
...
router.get("/", asyncHandler(function _callee9(req, res) {
...
router.post("/search", asyncHandler(function _callee10(req, res) {
  var query, path, Op, books, arrayCounts;
...
router.post('/:id/delete', asyncHandler(function _callee11(req, res) {
  var book;
